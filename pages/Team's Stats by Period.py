...
team,against=st.tabs(["Favor","Against"])
with team:
    ###### teams stats
    ...
    team_period_all_Stats=pd.merge(team_period_stats,team_games)
...
with against:
    ###### opponent stats
    team_against_period_all_Stats=pd.merge(team_period_stats_against,team_games.rename(columns={'Team':"Against"}))

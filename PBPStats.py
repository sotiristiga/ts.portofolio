    ...
    with tab12:
        ...
        with tab122:
            ...
            interactive_table(
                ...
                columnDefs=[{"className": "dt-center", "targets": "_all"}])
    with tab13:
        jumpball = pbp_data_2425.loc[(pbp_data_2425['PLAYTYPE'] == 'JB')]["Team"].value_counts().reset_index().rename(
            columns={'count': 'Jumpball'}).reset_index()
...
with tab3:
    ...
    with tab33:
        ...
        tab331, tab332, tab333, tab334 = st.tabs(
            ['4th Period points', "Last 5 minutes points", "Last 2 minutes points", 'Last minute points'])
        with tab331:
...
coachtimeout[['Team', 'Fixture', 'PERIOD']].value_counts().reset_index().groupby(['Team', 'PERIOD'])[
    'count'].mean().reset_index()
timeouts_perminute = \
coachtimeout[['Team', 'MINUTE', 'PERIOD']].value_counts().reset_index().groupby(['Team', 'PERIOD'])[
    'count'].mean().reset_index()
